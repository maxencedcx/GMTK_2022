namespace RSLib.Audio.UI
{
    ...
    public class UIAudioHandler : MonoBehaviour
    {
        ...
        private RSLib.GUI.EnhancedButton _enhancedButton;
        private RSLib.GUI.EnhancedToggle _enhancedToggle;
        private RSLib.GUI.EnhancedSlider _enhancedSlider;
        ...
        protected virtual void OnButtonPointerEnter(RSLib.GUI.EnhancedButton source)
        {
            UIAudioManager.PlayHoverClip();
        }
        
        protected virtual void OnTogglePointerEnter(RSLib.GUI.EnhancedToggle source)
        {
            UIAudioManager.PlayHoverClip();
        }
        
        protected virtual void OnSliderPointerEnter(RSLib.GUI.EnhancedSlider source)
        {
            UIAudioManager.PlayHoverClip();
        }
        ...
        private void Awake()
        {
            ...
            _enhancedButton = GetComponent<RSLib.GUI.EnhancedButton>();
            ...
            _enhancedToggle = GetComponent<RSLib.GUI.EnhancedToggle>();
            ...
            _enhancedSlider = GetComponent<RSLib.GUI.EnhancedSlider>();
