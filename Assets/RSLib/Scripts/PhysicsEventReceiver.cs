namespace RSLib
{
    ...
    public class PhysicsEventReceiver : MonoBehaviour
    {
        ...
        [Header("EVENTS")]
        [SerializeField] private Events.ColliderEvent _onTriggerEnter = null;
        [SerializeField] private Events.ColliderEvent _onTriggerExit = null;
        [SerializeField] private Events.CollisionEvent _onCollisionEnter = null;
        [SerializeField] private Events.CollisionEvent _onCollisionExit = null;
