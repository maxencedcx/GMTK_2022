namespace RSLib.Yield
{
    ...
    {
        private static System.Collections.Generic.Dictionary<float, WaitForSeconds> s_waitsForSeconds = new System.Collections.Generic.Dictionary<float, WaitForSeconds>(100, new Comparers.FloatComparer());
        private static System.Collections.Generic.Dictionary<float, WaitForSecondsRealtime> s_waitForFramesRealtimeCollection = new System.Collections.Generic.Dictionary<float, WaitForSecondsRealtime>(100, new Comparers.FloatComparer());
