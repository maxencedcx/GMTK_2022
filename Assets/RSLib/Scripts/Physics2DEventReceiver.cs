namespace RSLib
{
    ...
    public class Physics2DEventReceiver : MonoBehaviour
    {
        ...
        [Header("EVENTS")]
        [SerializeField] private Events.Collider2DEvent _onTriggerEnter = null;
        [SerializeField] private Events.Collider2DEvent _onTriggerExit = null;
        [SerializeField] private Events.Collision2DEvent _onCollisionEnter = null;
        [SerializeField] private Events.Collision2DEvent _onCollisionExit = null;
