Shader "GMTK/Intersection"
{
    Properties
    {
        _MainTex("MainTex",2D) = "white"{}
        _RimFactor("RimFactor",Range(0.0,5.0))=1.0
        _DistanceFactor("DistanceFactor",Range(0.0,20.0))=1.0
        _RimColor("RimColor",Color)=(1,0,0,1)
        _DistanceFactor2("DistanceFactor2",Range(0.0,20.0))=1.0
        _DistanceFactor3("DistanceFactor3",Range(0.0,20.0)) = 1.0
    }
    SubShader
    {
        Tags
